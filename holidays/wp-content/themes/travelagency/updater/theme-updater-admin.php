<?php
/**
 * Travelagency updater admin page and functions.
 */

class Travelagency_Updater_Admin {
	...
	function __construct( $config = array(), $strings = array() ) {
		...
		$config = wp_parse_args( $config, array(
			'remote_api_url' => 'https://wpbooking.org',
	...
	function updater() {
		...
		if ( !class_exists( 'Travelagency_Updater' ) ) {
			// Load our custom theme updater
			include( dirname( __FILE__ ) . '/theme-updater-class.php' );
		}

		new Travelagency_Updater(
			array(
