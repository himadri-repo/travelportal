<?php
    ...
    $tax_total    = 0;
?>
<h5 class="checkout-form-title"><?php esc_html_e( "Total", "travelagency" ) ?></h5>
    ...
    <div class="review-cart-item total">
        ...
        <?php
            ...
            if ( !empty( $cart[ 'deposit' ][ 'status' ] ) ) {
                ...
                <span
                    class="total-title text-bold"><?php esc_html_e( 'You\'ll pay at the property', 'travelagency' ) ?></span>
