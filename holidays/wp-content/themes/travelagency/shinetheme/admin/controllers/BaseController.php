...
if (!class_exists('TravelAgency_BaseAdminController')) {
    class TravelAgency_BaseAdminController
    {
        ...
        function __construct()
        {
            ...
            add_action('admin_footer', array($this, '_init_admin_scripts'));

        }

        function _init_admin_scripts()
        {
            ?>
            <script>
                jQuery(document).ready(function ($) {
                    $('.st_iconpicker').iconpicker();


                    //This for VC Elements
                    $(document).on('click', 'div.st_iconpicker input[type=text]', function () {
                    ...
                    $(document).on('click', 'input.st_iconpicker', function () {
                    ...
                    $(document).on('click', 'div.st_icon_awesome input[type=text]', function () {
                    ...
                    $(document).on('click','input.st_icon_awesome',function(){
                        if(!$(this).hasClass('st_icp_inited')){
                            $(this).iconpicker({
        ...
        function _add_admin_scripts()
        {
            ...
            wp_enqueue_style('st-admin-css', TravelAgency_Assets()->url('admin/css/admin.css'));
            wp_enqueue_script('st-iconpicker', TravelAgency_Assets()->url('js/lib/st-iconpicker/js/fontawesome-iconpicker.js'), array('jquery'), null, true);

            wp_enqueue_style('st-fontawesome', TravelAgency_Assets()->url('css/lib/font-awesome/css/fontawesome.min.css'));
            wp_enqueue_style('st-iconpicker', TravelAgency_Assets()->url('js/lib/st-iconpicker/css/fontawesome-iconpicker.min.css'));

            wp_enqueue_script('st-custom-js', TravelAgency_Assets()->url('admin/js/admin.js'), array('jquery'), null, true);
        }
    ...
    TravelAgency_BaseAdminController::inst();
}