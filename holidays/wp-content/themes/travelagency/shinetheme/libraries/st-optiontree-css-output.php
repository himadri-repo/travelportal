 ...
 * Time: 9:39 AM
 */
if (!class_exists('TravelAgency_CustomCSSOutput')) {

    class TravelAgency_CustomCSSOutput
    {
        ...
        function __construct()
        {
            ...
            add_filter('ot_recognized_font_families', array($this, 'ot_google_font_stack'), 1, 2);
        }
        ...
        function _options_allow_output()
        {
            $array = array(
                'typography',
                'color'
        ...
        function _get_output_item_css($fields, $settings)
        {
            $option_id = $fields['id'];
    ...
    TravelAgency_CustomCSSOutput::inst();
