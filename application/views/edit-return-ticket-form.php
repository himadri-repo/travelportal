                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1 content-side">
                        	<form id="frm_ticket" class="lg-booking-form" action="<?php echo base_url();?>user/update-ticket"method="POST"  autocomplete="off" onsubmit="return addreturn()"> 							    							    
									...
									<div class="personal-info"> 									
												...
												<div class="form-group">													
													<select class="form-control right-icon" name="airline" id="airline">
													 <option value="">Airline</option>
													  ...
													  {
													  ?>
													  <option color="<?php echo $airline[$key]["aircode"];?>" value="<?php echo $airline[$key]["id"];?>" <?php if($flight[0]["airline1"]==$airline[$key]["id"]) echo "selected";?>> <?php echo $airline[$key]["airline"];?></option>
													  <?php
													  }
													   ?>										 
													</select>
											...
											<div class="col-xs-6 col-sm-3">
												<div class="form-group">
													...
													<div class="controls input-append date form_datetime" data-date="<?php echo date("Y-m-d h:i:s");?>" data-date-format="dd MM yyyy - HH:ii p" data-link-field="departure_date_time" >
														<input  class="form-control" type="text"   readonly Placeholder="20 Aug 2018 - 11:00 am" value="<?php echo date("jS M Y h:i a",strtotime($flight[0]["departure_date_time"])); ?>">
														<span class="add-on"><i class="icon-remove"></i></span>
														<span class="add-on"><i class="icon-th"></i></span>
														<input type="hidden" id="departure_date_time" name="departure_date_time"  value="<?php echo $flight[0]["departure_date_time"]; ?>" />
													</div>
												</div><!-- end form-group -->
											</div><!-- end columns -->
											 <div class="col-xs-6 col-sm-3">
											...
											<div class="col-xs-6 col-sm-3">
												<div class="form-group">
													...
													<div class="controls input-append date form_datetime" data-date="<?php echo date("Y-m-d h:i:s");?>" data-date-format="dd MM yyyy - HH:ii p" data-link-field="arrival_date_time" >
														<input  class="form-control" type="text"  readonly Placeholder="20 Aug 2018 - 11:00 am" value="<?php echo date("jS M Y h:i a",strtotime($flight[0]["arrival_date_time"])); ?>">
														<span class="add-on"><i class="icon-remove"></i></span>
														<span class="add-on"><i class="icon-th"></i></span>
														<input type="hidden" id="arrival_date_time" name="arrival_date_time"  value="<?php echo $flight[0]["arrival_date_time"]; ?>" />
													</div>
												</div><!-- end form-group -->
											</div><!-- end columns -->
											<div class="col-xs-6 col-sm-3">
										...
										<div class="row" id="div_returns">
											...
											<div class="col-xs-6 col-sm-3">
												<div class="form-group">
												  <input type="text" class="form-control" name="aircode1" id="aircode1" placeholder="AirCode" readonly value="<?php echo $flight[0]["aircode1"] ?>"/>
												</div>
											</div>
                                            <div class="col-xs-6 col-sm-3">
											   	<label>Departure Date Time</label>
											...
											<div class="col-xs-6 col-sm-3">
												<div class="form-group">
													...
													<div class="controls input-append date form_datetime" data-date="<?php echo date("Y-m-d h:i:s");?>" data-date-format="dd MM yyyy - HH:ii p" data-link-field="departure_date_time1" >
														<input  class="form-control" type="text"   readonly Placeholder="20 Aug 2018 - 11:00 am" value="<?php echo date("jS M Y h:i a",strtotime($flight[0]["departure_date_time1"])); ?>">
														<span class="add-on"><i class="icon-remove"></i></span>
														<span class="add-on"><i class="icon-th"></i></span>
														<input type="hidden" id="departure_date_time1" name="departure_date_time1"  value="<?php echo $flight[0]["departure_date_time1"] ?>" />
													</div>
												</div><!-- end form-group -->
											</div><!-- end columns -->
											<div class="col-xs-6 col-sm-3">
											...
											<div class="col-xs-6 col-sm-3">
												<div class="form-group">													
													<div class="controls input-append date form_datetime" data-date="<?php echo date("Y-m-d h:i:s");?>" data-date-format="dd MM yyyy - HH:ii p" data-link-field="arrival_date_time1" >
														<input  class="form-control" type="text"    readonly Placeholder="20 Aug 2018 - 11:00 am" value="<?php echo date("jS M Y h:i a",strtotime($flight[0]["arrival_date_time1"])); ?>" >
														<span class="add-on"><i class="icon-remove"></i></span>
														<span class="add-on"><i class="icon-th"></i></span>
														<input type="hidden" id="arrival_date_time1" name="arrival_date_time1"   value="<?php echo $flight[0]["arrival_date_time1"] ?>" />
													</div>
												</div><!-- end form-group -->
											</div><!-- end columns -->
											...
											<div class="col-xs-6 col-sm-3">
												<div class="form-group">													
													<input type="text" class="form-control" name="flight_no1" id="flight_no1" placeholder="Flight No." value="<?php echo $flight[0]["flight_no1"]; ?>" />
												</div>
											</div>
											...
											<div class="col-xs-6 col-sm-3">
												<div class="form-group right-icon">													
													<select class="form-control" name="no_of_stops1" id="no_of_stops1">		
													  <option value="0" <?php if($flight[0]["no_of_stops1"]==0) echo "selected"; ?>>0</option>
													  <option value="1" <?php if($flight[0]["no_of_stops1"]==1) echo "selected"; ?>>1</option>
													  <option value="2" <?php if($flight[0]["no_of_stops1"]==2) echo "selected"; ?>>2</option>
													  <option value="3" <?php if($flight[0]["no_of_stops1"]==3) echo "selected"; ?>>3</option>
													  <option value="4" <?php if($flight[0]["no_of_stops1"]==4) echo "selected"; ?>>4</option>													  
											...
											<div id="div_stop1" <?php if($flight[0]["no_of_stops"]>0) { echo "style='display:block'";}else {echo "style='display:none'";}?>>
												...
												<?php 
													...
													?>
														...
														<div class="col-xs-6 col-sm-6">
															<div class="form-group">												
																<input type="text" class="form-control" name="stop_name1[]"  placeholder="Stop Name" value="<?php echo $value;?>" />
															</div>
														</div>
                                                        </div>														
												<?php 
											...
											<div class="col-xs-6 col-sm-3">
												<div class="form-group right-icon">
													...
													<select class="form-control" name="terminal2" id="terminal2">										   
													  <option value="1" <?php if($flight[0]["terminal2"]==1) echo "selected"; ?>>1</option>
													  <option value="2" <?php if($flight[0]["terminal2"]==2) echo "selected"; ?>>2</option>
													  <option value="3" <?php if($flight[0]["terminal2"]==3) echo "selected"; ?>>3</option>
													  <option value="4" <?php if($flight[0]["terminal2"]==4) echo "selected"; ?>>4</option>													  
													  <option value="NA" <?php if($flight[0]["terminal2"]=="NA") echo "selected"; ?>>NA</option>
													</select>
													<i class="fa fa-angle-down" ></i>
												</div>
											</div>
											...
											<div class="col-xs-6 col-sm-3">
												<div class="form-group right-icon">
													...
													<select class="form-control" name="terminal3" id="terminal3">										   
													  <option value="1" <?php if($flight[0]["terminal3"]==1) echo "selected"; ?>>1</option>
													  <option value="2" <?php if($flight[0]["terminal3"]==2) echo "selected"; ?>>2</option>
													  <option value="3" <?php if($flight[0]["terminal3"]==3) echo "selected"; ?>>3</option>
													  <option value="4" <?php if($flight[0]["terminal3"]==4) echo "selected"; ?>>4</option>	
													   <option value="NA" <?php if($flight[0]["terminal3"]=="NA") echo "selected"; ?>>NA</option>
													</select>
													<i class="fa fa-angle-down" ></i>
												</div>
											</div>
											...
											<div class="col-xs-6 col-sm-3">
												<div class="form-group right-icon">													
													<select class="form-control" name="class1" id="class1">													  
													  <option value="FIRST" <?php if($flight[0]["class1"]=="FIRST") echo "selected"; ?>>First Class</option>
													  <option value="BUSINESS" <?php if($flight[0]["class1"]=="BUSINESS") echo "selected"; ?>>Business Class</option>
													  <option value="PREMIUM" <?php if($flight[0]["class1"]=="PREMIUM") echo "selected"; ?>>Premium Economy Class</option>
													  <option value="ECONOMY" <?php if($flight[0]["class1"]=="ECONOMY") echo "selected"; ?>>Economy Class</option>
													</select>
													<i class="fa fa-angle-down"></i>
												</div>
											</div>
										...
										<div class="row">
											...
											<div class="col-xs-6 col-sm-3">
												<div class="form-group">													
													<input type="text" class="form-control" name="total" id="total" placeholder="6000"  readonly value="<?php echo $flight[0]["total"]; ?>"/>
												</div>
											</div>
