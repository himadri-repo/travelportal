									...
									<div class="list-content">
										...
										<div class="main-img list-img f-list-img">
											...
											<ul class="list-unstyled flight-timing">
											    <?php if($flight[$key]["sale_type"]!="quote"){ ?>
												<li><span><i class="fa fa-plane"></i></span><span class="date"><?php echo date("jS M y",strtotime($flight[$key]["departure_date_time"])); ?> </span>(<?php echo date("h:i a",strtotime($flight[$key]["departure_date_time"])); ?>)</li>
												<li><span><i class="fa fa-plane"></i></span><span class="date"><?php echo date("jS M y",strtotime($flight[$key]["arrival_date_time"])); ?> </span>(<?php echo date("h:i a",strtotime($flight[$key]["arrival_date_time"])); ?>)</li>
											    <?php } ?>
											</ul>
										</div><!-- end f-list-img -->
										...
										<div class="list-info f-list-info" style="padding:30px 30px 0 30px;">
											...
											<?php if($flight[$key]["sale_type"]!="quote"){ ?>
											<p class="block-minor"><span><i class="fa fa-users"></i>&nbsp;&nbsp;<?php echo $flight[$key]["no_of_person"];?>&nbsp;&nbsp; SEATS,&nbsp;&nbsp;<i class="fa fa-plane"></i>&nbsp;<?php echo $flight[$key]["no_of_stops"];?>&nbsp;STOP</span> </p>
											<p class="block-minor"><span><i class="fa fa-hotel"></i>&nbsp;&nbsp;<?php echo $flight[$key]["class"]." Class";?></span></p>
											<?php } else {?>
