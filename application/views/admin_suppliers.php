    ...
    <div class="row">
        <div class="col-md-12 col-xs-12 col-sm-12">
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#home">My Suppliers</a></li>
                <li><a data-toggle="tab" href="#search">Search Suppliers</a></li>
            </ul>
        </div>
    </div>
    <div class="tab-content">
                    ...
                    <div style="background:#EFF3F8;border:1px solid #ccc; min-height:50vh" >
                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody id="grid">											                                            
                                ...
                                ?>
                                    <tr><td colspan="5"><span style="padding:10px">No supplier registered!!</span></td></tr>
                                <?php
                                }
                                ?>
                            </tbody>
        ...
        <div id="search" class="tab-pane fade">
            <div class="row">
                <div class="col-md-12 col-xs-12 col-sm-12">
                    <div style="background:#EFF3F8;border:1px solid #ccc; min-height:50vh" >
                        <span style="padding:10px">Search suppliers</span>
                    </div>
                </div>
            </div>
        </div>
