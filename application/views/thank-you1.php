                    	...
                    	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 content-side">
                        	<div class="space-right">
                            	...
                            	<div class="thank-you-note col-md-6 col-xs-6 col-sm-6">
								   ...
								   <p><i class="fa fa-calendar"></i></span><?php echo date("d-m-Y",strtotime($details[0]["date"]));?></p>
								   <p><i class="fa fa-envelope"></i></span> <?php echo $details[0]["email"];?></p>
								   <p><i class="fa fa-phone"></i></span><?php echo $details[0]["mobile"];?></p>					   
                                </div>
								
								<div class="thank-you-note col-md-6 col-xs-6 col-sm-6">
                                  
								   
								   <h3 class="pull-right"><?php echo $setting[0]["site_title"];?></h3> 
								   <p class="pull-right"><span><i class="fa fa-envelope"></i></span> <?php echo $setting[0]["email"];?></p>
								   <p class="pull-right"><span><i class="fa fa-phone"></i></span><?php echo $setting[0]["phone_no"];?></p>
                               			...
                               			<table class="table">
                                        	<tbody>
												...
												<tr>
													...
													<?php 
													$rate=$details[0]["price"]+$details[0]["markup"];
													$qty=$details[0]["qty"];
													$sub_total=$rate*$qty;
													$total=$sub_total+$details[0]["service_charge"]+$details[0]["igst"]+$details[0]["sgst"]+$details[0]["cgst"];
													?>
													<td><label>Ticket Fare (each) : </label><?php echo number_format($rate,2,".",","); ?><br/>
													<label>Qty : </label><?php echo $details[0]["qty"]; ?><br/>													
													<label>Sub Total : </label><?php echo number_format($sub_total,2,".",","); ?><br/>
													...
													<label>Grand Total : </label><?php echo number_format($total,2,".",","); ?></td>
