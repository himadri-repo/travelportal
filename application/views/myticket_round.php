...
<html lang="en">
<head>
	<title>Air Ticket No - <?php echo "Going -> BK-".$ob_details[0]["id"]." | Return -> BK-".$ib_details[0]["id"] ?></title>
	<meta charset="utf-8">
...
<div style="width: 720px; height: auto; overflow: auto; display: block; padding-right: 15px; padding-left: 15px; margin-right: auto; margin-left: auto;">
	...
	<div style="margin-bottom: 35px; margin-top: 20px; margin-left: -15px; margin-right: -15px; height: auto; margin-top: 10px; margin-bottom: 10px;">
		<div style="width: 30%; float: left">
			...
			?>
				<h2 style="padding: 0; margin: 0;"><?php echo $ob_details[0]["name"];?></h2> 
				<div><span><i class="fa fa-envelope"></i></span> <?php echo $ob_details[0]["email"];?></div>
				<div><span><i class="fa fa-phone"></i></span> <?php echo $ob_details[0]["mobile"];?></div>
				<div><span><i class="fa fa-map-marker"></i></span> <?php echo $ob_details[0]["address"];?></div>
			<?php 
			} else { ?>
		...
		<div style="width: 30%; text-align: right; float: left;">
			<h2 style="padding: 0; margin: 0;"><?php echo $ob_details[0]["first_name"].' '.$ob_details[0]["last_name"];?></h3>
			<div><span><i class="fa fa-calendar"></i></span> <?php echo date("d-m-Y",strtotime($ob_details[0]["date"]));?></div>
			<div><span><i class="fa fa-envelope"></i></span> <?php echo $ob_details[0]["cemail"];?></div>
			<div><span><i class="fa fa-phone"></i></span> <?php echo $ob_details[0]["mobile_no"];?></div>
	...
	<div style="margin-bottom: 35px; margin-top: 20px; margin-left: -15px; margin-right: -15px; height: auto; margin-top: 10px; margin-bottom: 10px;">
		<div style="width: 100%;">
			<span style="font-size: 14px; font-weight: 600; color: #d87811;">
				<i class="fa fa-info-circle"></i> Passenger Details [<?php echo $ob_details[0]["source"]." To ".$ob_details[0]["destination"];?>]
				<!-- <span><?php if($ob_details[0]["trip_type"]=="ONE") echo "ONE WAY"; if($ob_details[0]["trip_type"]=="ROUND") echo "ROUND TRIP"; ?></span> -->
			</span>
		</div>
			...
			<table>
				...
				<tbody>
					...
					?>
						<tr>
							<td><?php echo $ctr;?></td>
							<td><?php echo $ob_details[$key]["prefix"]." ".$ob_details[$key]["first_name"]." ".$ob_details[$key]["last_name"] ?></td>
	...
	<div style="margin-bottom: 35px; margin-top: 20px; margin-left: -15px; margin-right: -15px; height: auto; margin-top: 10px; margin-bottom: 10px;">
		<div style="width: 100%;">
			<span style="font-size: 14px; font-weight: 600; color: #d87811;">
				<i class="fa fa-info-circle"></i> Passenger Details [<?php echo $ib_details[0]["source"]." To ".$ib_details[0]["destination"];?>]
				<!-- <span><?php if($ib_details[0]["trip_type"]=="ONE") echo "ONE WAY"; if($ib_details[0]["trip_type"]=="ROUND") echo "ROUND TRIP"; ?></span> -->
			</span>
		</div>
		<div style="width: 100%; float: left;">
			<table>
				...
				<tbody>
					...
					?>
						<tr>
							<td><?php echo $ctr;?></td>
							<td><?php echo $ib_details[$key]["prefix"]." ".$ib_details[$key]["first_name"]." ".$ib_details[$key]["last_name"] ?></td>
	...
	<?php 
		...
		// $dateDiff1 = intval((strtotime($ob_details[0]["arrival_date_time1"])-strtotime($ob_details[0]["departure_date_time1"]))/60);
	?>
	<!-- third row-section -->
	<div style="margin-bottom: 35px; margin-top: 20px; margin-left: -15px; margin-right: -15px; height: auto; margin-top: 10px; margin-bottom: 10px;">
		...
		<div style="width: 100%; float: left;">
			<table>
				...
				<tbody>
					<tr>
						<td style="padding: 10px;">
							<div style="width: 10%;display: inline-block;">
								<img style="width: 18px; height: 18px;" src="<?php echo base_url(); ?>upload/thumb/<?php echo $ob_details[0]["image"]; ?>" alt="<?php echo $ob_details[0]["airline"];?>">
							</div>
							<div style="width: 70%; display: inline-block; float: right;">
								<div style="">
									<?php echo $ob_details[0]["airline"];?><br/>
						...
						<td style="padding: 10px;">
							<div style="display: inline-block;">
								<div style="">
									...
									<div style="margin: 0px 23px;">Terminal - <?php echo $ob_details[0]["terminal"];?></div>
						...
						<td style="padding: 10px;">
							<div style="display: inline-block;">
								<div style="">
									...
									<div style="margin: 0px 23px;">Terminal - <?php echo $ob_details[0]["terminal2"];?></div>
									<div style="margin: 0px 23px;">
					...
					<?php
					if($ib_details[0]["trip_type"]=="ONE") {
						$dateDiff = intval((strtotime($ib_details[0]["arrival_date_time"])-strtotime($ib_details[0]["departure_date_time"]))/60);
					?>
					<tr>
						<td style="padding: 10px;">
							<div style="width: 10%;display: inline-block;">
								<img style="width: 18px; height: 18px;" src="<?php echo base_url(); ?>upload/thumb/<?php echo $ib_details[0]["image"]; ?>" alt="<?php echo $ib_details[0]["airline"];?>">
							</div>
							<div style="width: 70%; display: inline-block; float: right;">
								<div style="">
									<?php echo $ib_details[0]["airline"];?><br/>
						...
						<td style="padding: 10px;">
							<div style="display: inline-block;">
								<div style="">
									...
									<div style="margin: 0px 23px;">Terminal - <?php echo $ib_details[0]["terminal"];?></div>
									<div style="margin: 0px 23px;">
						...
						<td style="padding: 10px;">
							<div style="display: inline-block;">
								<div style="">
									...
									<div style="margin: 0px 23px;">Terminal - <?php echo $ib_details[0]["terminal2"];?></div>
									<div style="margin: 0px 23px;">
	...
	<?php 
	$primary_passenger = $ob_details[0];
	$adult = intval($primary_passenger['adult']);
	$child = intval($primary_passenger['child']);
	$infant = intval($primary_passenger['infant']);

	$tax = floatval($ob_details[0]["service_charge"]) + floatval($ib_details[0]["service_charge"]);
	$others = floatval($ob_details[0]["sgst"]) + floatval($ob_details[0]["cgst"]) + floatval($ib_details[0]["sgst"]) + floatval($ib_details[0]["cgst"]);

	$admin_markup = (floatval($ob_details[0]["admin_markup"]) + floatval($ib_details[0]["admin_markup"])) * ($adult+$child);
	$total_taxothers = $tax + $others + $admin_markup;

	$total = (floatval($ob_details[0]["total"]) + floatval($ib_details[0]["total"])) + $admin_markup;
	?>
	<!-- forth row-section -->
	<div style="margin-bottom: 35px; margin-top: 20px; margin-left: -15px; margin-right: -15px; height: auto; margin-top: 10px; margin-bottom: 10px;">
		...
		<div style="width: 100%; float: left;">
			<table>
				...
				<tbody>
					<tr>
						<td style="text-align: center;">Going -> BK-<?php echo $ob_details[0]["id"];?></br>Return -> BK-<?php echo $ib_details[0]["id"];?></td>
						<td style="text-align: center;"><?php echo "Going ->".date("d/m/Y",strtotime($ob_details[0]["date"]));?></br>Return -><?= date("d/m/Y",strtotime($ib_details[0]["date"]));?></td>
						<td>
							<?php 
							...
							<table style="border: 0px; padding: 0px;">
								<tr>
									...
									<td style="width: 33.33%; text-align: right; padding: 0px;"><?php echo number_format($rate,2,".",","); ?></td>
								</tr>
								<?php if($adult > 0) { ?>
								<tr>
									<td style="width: 66.66%; padding: 0px;"><label>Adult : </label></td>
									<td style="width: 33.33%; text-align: right; padding: 0px;"><?= $adult.' x '.number_format($rate,2,".",","); ?></td>
								</tr>
								<?php } ?>
								<?php if($child > 0) { ?>
								<tr>
									<td style="width: 66.66%; padding: 0px;"><label>Child : </label></td>
									<td style="width: 33.33%; text-align: right; padding: 0px;"><?= $child.' x '.number_format($rate,2,".",","); ?></td>
								</tr>
								<?php } ?>
								<?php if($infant > 0) { ?>
								<tr>
									<td style="width: 66.66%; padding: 0px;"><label>Infant : </label></td>
									<td style="width: 33.33%; text-align: right; padding: 0px;"><?= $infant.' x '.number_format($infant_rate,2,".",","); ?></td>
								</tr>
								<?php } ?>
								<tr>
						...
						<td style="text-align: center;">
							<?php echo (($ob_details[0]["customer_status"] === $ob_details[0]["status"]) ? $ob_details[0]["status"] : "PENDING");?></br>
							<?php echo (($ib_details[0]["customer_status"] === $ib_details[0]["status"]) ? $ib_details[0]["status"] : "PENDING");?></br>
						</td>
					</tr>
				</tbody>
			</table>
						...
						<td>
							...
							<table style="border: 0px; padding: 0px;">
								<tr>
									...
									<td style="width: 45%; text-align: right; padding: 0px;"><?php echo number_format($rate,2,".",","); ?></td>
								</tr>
								<?php if($adult > 0) { ?>
								<tr>
									<td style="width: 55%; padding: 0px;"><label>Adult : </label></td>
									<td style="width: 45%; text-align: right; padding: 0px;"><?= $adult.' x '.number_format($rate,2,".",","); ?></td>
								</tr>
								<?php } ?>
								<?php if($child > 0) { ?>
								<tr>
									<td style="width: 55%; padding: 0px;"><label>Child : </label></td>
									<td style="width: 45%; text-align: right; padding: 0px;"><?= $child.' x '.number_format($rate,2,".",","); ?></td>
								</tr>
								<?php } ?>
								<?php if($infant > 0) { ?>
								<tr>
									<td style="width: 55%; padding: 0px;"><label>Infant : </label></td>
									<td style="width: 45%; text-align: right; padding: 0px;"><?= $infant.' x '.number_format($infant_rate,2,".",","); ?></td>
								</tr>
								<?php } ?>
								<tr>
								...
								<tr>
									...
									<td style="width: 45%; text-align: right; padding: 0px; padding: 0px; font-weight: 800;"><?php echo number_format($total,2,".",","); ?></td>
								</tr>
							</table>
							<?php
							}
