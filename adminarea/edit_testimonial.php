...
?>
<title>Edit Testimonial | <?php echo $row_top['site_title']; ?></title>
</head>
            <?php 
				...
				<div class="main-content-inner">
					<div class="page-content">
                        ...
                        <div class="row">
							  ...
							  <div class="form-group has-info col-sm-2" style="float:left;margin-top:15px">									
								<a href="testimonial.php" class="pull-left btn btn-sm btn-default col-md-10" id="btn_cancel">															
									...
									<div class="widget-body"><!--Widget Body start-->
										<form  id="frm_slider" enctype="multipart/form-data">							
											...
											<div class="form-group has-info col-xs-12 col-sm-12">
													<label class="col-sm-12 control-label" for="form-field-1" style="text-align:left"> Status (required) </label>
													<div class="col-xs-12 col-sm-12">
														<select class="col-xs-12 col-sm-12" id="approved" name="approved">
...
<?php include_once('footer.php');?>
 <script src="<?php echo $baseurl;?>/adminarea/script/edit_testimonial.js"></script> 
