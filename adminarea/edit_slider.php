...
?>
<title>Edit Slider | <?php echo $row_top['site_title']; ?></title>
</head>
            <?php 
				...
				<div class="main-content-inner">
					<div class="page-content">
						<div class="page-header" id="header"><!--.page-header -->
							<h1>
								Edit Slider	(Please Use 1920 x 1080 px image for best output)				
							</h1>							
						</div><!-- /.page-header -->
...
<?php include_once('footer.php');?>
 <script src="<?php echo $baseurl;?>/adminarea/script/edit_slider.js"></script> 
