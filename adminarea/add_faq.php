...
?>
<title>Add FAQ | <?php echo $row_top['site_title']; ?></title>
</head>
            <?php 
				...
				<div class="main-content-inner">
					<div class="page-content">
                        ...
                        <div class="row">
							  ...
							  <div class="form-group has-info col-sm-2" style="float:left;margin-top:15px">									
								<a href="faq.php" class="pull-left btn btn-sm btn-default col-md-10" id="btn_cancel">															
...
<?php include_once('footer.php');?>
 <script src="<?php echo $baseurl;?>/adminarea/script/add_faq.js"></script> 
