...
?>
<title>Profession | <?php echo $row_top['site_title']; ?></title>
</head>
            <?php 
					...
					<div class="page-content">
						...
						<div class="row">
							   <div class="form-group has-info col-sm-6" style="float:left;margin-top:15px">									
								<a href="add_profession.php" class="pull-left btn btn-sm btn-primary">															
...
<?php include_once('footer.php');?>
 <script src="<?php echo $baseurl;?>/adminarea/script/profession.js"></script>  			