...
?>
<title>Add Term & Conditions | <?php echo $row_top['site_title']; ?></title>
</head>
            <?php 
				...
				<div class="main-content-inner">
					<div class="page-content">
                        ...
                        <div class="row">
							  ...
							  <div class="form-group has-info col-sm-2" style="float:left;margin-top:15px">									
								<a href="term.php" class="pull-left btn btn-sm btn-default col-md-10" id="btn_cancel">															
									...
									<div class="widget-body"><!--Widget Body start-->
										<form  id="frm_slider" enctype="multipart/form-data">							
											...
											<div class="form-group has-info col-xs-12 col-sm-12">
													<label class="col-sm-12 control-label" for="form-field-1" style="text-align:left"> Question (required)</label>
													<div class="col-xs-12 col-sm-12">
														<input type="text" id="txt_title" name="txt_title" placeholder="Question" class="col-xs-12 col-sm-12">
													</div>
											</div>
...
<?php include_once('footer.php');?>
 <script src="<?php echo $baseurl;?>/adminarea/script/add_term.js"></script> 
