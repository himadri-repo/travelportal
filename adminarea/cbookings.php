...
<title>Bookings | <?php echo $row_top['site_title']; ?></title>
</head>
            <?php 
                                ...
                                <div class="form-group has-info col-sm-12" style="float:left;margin-top:15px">																											
									<div class="col-sm-2" id="div_txt_name">
                                      ...
                                      <select  class="col-xs-12 col-sm-12" name="field" id="field">	
										...
										<option value="b.status">Status</option>
									...
									<div class="col-sm-3" id="div_status">
									  <select  class="col-xs-12 col-sm-12" name="status" id="status">	
										...
										<option value="PROCESSING FOR CANCEL">Requested For Cancel</option>
										<option value="CANCELLED">Cancelled</option>
									  </select>
									</div> 
									
									<div class="col-sm-3" id="div_user" style="display:none">
...
<?php include_once('footer.php');?>
 ...
 <script src="<?php echo $baseurl;?>/adminarea/script/cbookings.js"></script>  
