...
?>
<title>FAQ | <?php echo $row_top['site_title']; ?></title>
</head>
            <?php 
					...
					<div class="page-content">
						...
						<div class="row">
							   <div class="form-group has-info col-sm-6" style="float:left;margin-top:15px">									
								<a href="add_faq.php" class="pull-left btn btn-sm btn-primary" id="btn_add">															
						...
						<div class="row">
							<div class="col-xs-12">																				
                                ...
                                <div class="form-group has-info col-sm-6" style="float:left;margin-top:15px">									
									<label class="col-sm-4 control-label no-padding-right" for="form-field-username">Search With Question</label>									
...
<?php include_once('footer.php');?>
 <script src="<?php echo $baseurl;?>/adminarea/script/faq.js"></script>  			